...
class SampleApp(tk.Tk):
	...
	if selection[0] == "0":
	    ...
	    myFileName = StringVar(value="whitelist.txt")
	    ...
	    createRule = tk.Button(self.labelFrame1, text="Create Table")
	    test1.pack(anchor=W)
	    tableEntry.pack(anchor=W)
	    fileEntry.pack(anchor=W)
	    browseFile.pack(anchor=W)
	    createRule.pack(anchor=W)
	    ...
	    self.labelFrame2.pack(side=RIGHT,fill="both",expand="YES",padx=5, pady=5)
            test2 = tk.Label(self.labelFrame2, text="Load Ruleset")
	    loadRuleButton = tk.Label(self.labelFrame2, text="Apply Ruleset")	
	    test2.pack(anchor=W)
	    loadRuleButton.pack(anchor=W)	
	    ...
	    self.labelFrame3.pack(side=RIGHT,fill="both",expand="YES",padx=5, pady=5)
            test2 = tk.Label(self.labelFrame3, text="Load Ruleset")
	    loadRuleButton = tk.Button(self.labelFrame3, text="Apply Ruleset")	
	    test2.pack(anchor=W)
	    loadRuleButton.pack(anchor=W)	
